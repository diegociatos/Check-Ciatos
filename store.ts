...
// Removed UserCredentials from imports as it's not defined in types.ts and not used here.
...
export const useStore = () => {
  ...
  const addUser = useCallback((userData: Partial<User>) => {
    ...
    setBaseUsers(prev => [...prev, { ...userData as User, Senha: '123456', SenhaProvisoria: true, DataCriacao: new Date().toISOString(), Status: UserStatus.ATIVO, TentativasFalhadas: 0 }]);
  }, [baseUsers]);
